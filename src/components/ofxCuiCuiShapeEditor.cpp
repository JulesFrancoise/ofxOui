...
ofxCuiCui::ShapeEditor::ShapeEditor(float x_, float y_, float width_,
    ...
    ofAddListener(ofEvents().mousePressed, this,
                  &ofxCuiCui::ShapeEditor::mousePressed);
    ofAddListener(ofEvents().mouseDragged, this,
                  &ofxCuiCui::ShapeEditor::mouseDragged);
    ofAddListener(ofEvents().mouseReleased, this,
                  &ofxCuiCui::ShapeEditor::mouseReleased);
    ofAddListener(ofEvents().keyPressed, this,
                  &ofxCuiCui::ShapeEditor::keyPressed);
    ofAddListener(ofEvents().keyReleased, this,
                  &ofxCuiCui::ShapeEditor::keyReleased);
}

ofxCuiCui::ShapeEditor::~ShapeEditor() {
...
void ofxCuiCui::ShapeEditor::draw() {
    ofTranslate(x, y);
...
void ofxCuiCui::ShapeEditor::mousePressed(ofMouseEventArgs &e) {
...
void ofxCuiCui::ShapeEditor::mouseDragged(ofMouseEventArgs &e) {
    ...
    ofxCuiCui::ShapeEditor::EditEvent event = ofxCuiCui::ShapeEditor::EditEvent(
...
void ofxCuiCui::ShapeEditor::mouseReleased(ofMouseEventArgs &e) {
    if (dragging_ == Selector::None) return;
    if (dragging_mode_ == MouseDraggingMode::Rotation) {
        // RotateEvent
    } else {
...
void ofxCuiCui::ShapeEditor::keyPressed(ofKeyEventArgs &e) {
    if (e.key == OF_KEY_ALT) {
...
void ofxCuiCui::ShapeEditor::keyReleased(ofKeyEventArgs &e) {
...
void ofxCuiCui::ShapeEditor::mouseDraggedNormal(ofMouseEventArgs &e) {
    if (dragging_ == Selector::Shape) {
...
void ofxCuiCui::ShapeEditor::mouseDraggedSymmetric(ofMouseEventArgs &e) {
    if (dragging_ == Selector::Shape) {
        x = e.x + mouse_offset_.x;
        y = e.y + mouse_offset_.y;
    } else {
...
void ofxCuiCui::ShapeEditor::mouseDraggedRotation(ofMouseEventArgs &e) {
...
ofxCuiCui::ShapeEditor::EditEvent::EditEvent(ShapeEditor *sender_, Type type_,
